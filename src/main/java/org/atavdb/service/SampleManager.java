...
public class SampleManager {
    ...
    public void init(FilterManager filter) {
    ...
    private boolean checkSampleCount(FilterManager filter) {
    ...
    private void initAllSampleFromDB(FilterManager filter) {
        getMap(filter).clear();
